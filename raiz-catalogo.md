...
| Construcción modular de base (postes, vigas, 3 tipos de pared, cubierta, tarima; poste/paredes con colisión) | parcial |
...
dos vigas paralelas separadas 1–3,6 m: calcula el centro, el ángulo y el vano del tramo); tarima
elevada (colocación libre, como la fogata o la cama); fantasma verde/rojo según validez y material
disponible. Con estas piezas ya se puede levantar un refugio módulo a módulo — postes, vigas, una
pared (zarzo/troncos/corteza, a elegir), un techo y un suelo — que da tanto abrigo (`shelterQ`) como
el refugio de una pieza.

**Colisión:** el poste bloquea el paso como un tronco fino (radio 0,3 m) y las tres paredes
(zarzo/troncos/corteza) bloquean como un segmento entre sus dos postes (medio ancho 0,4 m) — ya no
se puede atravesar caminando. Viga, cubierta y tarima quedan por encima de la cabeza o bajo los pies
y no bloquean.

**Gestión de cualquier estructura ya puesta** (piezas modulares y también fogata, refugio,
...
| Pared de zarzo | varas + cordel | hecho — ligera, poco aislante, bloquea el paso |
| Pared de troncos | leña | hecho — pesada, muy aislante, bloquea el paso |
